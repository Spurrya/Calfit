  ...
  $("#register-form").submit(function(e) {
    ...
    register(function (registrationId) {
     ...
     $.ajax({
          ...
          data: {response_type: 'code', client_id: '3954fa24-2c18-4994-8776-5190b784edf5', resource:'https://outlook.office365.com/', state:generateUUID(), redirect_uri:'http://calfit.azurewebsites.net/api/login'},
          success: function(result)
          {
            console.log(result)
